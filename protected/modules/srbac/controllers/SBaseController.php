...
class SBaseController extends CController {
  ...
  protected function onUnauthorizedAccess() {
    ...
    if (Yii::app()->user->isGuest) {
      ...
      $error["code"] = " 403 ";
      $error["title"] = Helper::translate('srbac', 'Non sei autorizzato a compiere questa azione');
      $error["message"] = Helper::translate('srbac', 'Impedito l\'accesso a: ') . ' ' . $mod . "/" . $this->id . "/" . $this->action->id . ".";
